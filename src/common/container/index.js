    ...
    return (
      <Layout className="containAll">
        <Sider
          ...
          className="leftMenu"
        >
          {this.state.theme === 'light' ? <a href="#" target='_blank' rel='noopener noreferrer'><Icon type="aliwangwang" className="aliwangwang" /></a> :
            <a href="#" target='_blank' rel='noopener noreferrer'><Icon type="aliwangwang" className="aliwangwang white" /></a> }
          { this.state.theme === 'light' ? <span className="author">bt</span> : <span className="author white">bt</span> }
          <Menu
